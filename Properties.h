...
static const int NUM_EMPTY_SPACES = NUM_RANKS * NUM_FILES - PIECES.size() * 2; // number of empty squares at start of game
static const std::string EXIT_CODES = // what the program should return
"Exit codes:\n"
" 0 : Program exited successfully.\n"
"-1 : Program exited with an error.\n";
static const std::string COMMAND_CODES = // commands player can make during their turn
